...
<body>
    <header class="header-static navbar-sticky navbar-light shadow">
        <nav class="navbar navbar-expand-lg">
            <div class="container"> 
            <!-- Logo --> 
                <p class="logo"><a class="navbar-brand dropdown-item" href="/"> <img src="images/logo-header.png" alt="travelgo"> </a></p> 
                <button class="navbar-toggler ml-auto btn-categoria" type="button" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"> </span> </button>
                <div class="collapse navbar-collapse nav-categorias" id="navbarCollapse">
                    <ul class="navbar-nav ml-auto">
                        <!-- Menu item 1 Demos-->
                        <li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle" href="#" id="demosMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Categorias</a>
                            <ul class="dropdown-menu" aria-labelledby="homeMenu">
                            <li><a class="dropdown-item" href="/categorias"><i class="fas fa-laptop"></i> Tecnologia <span>1029</span></a></li>
                            <li><a class="dropdown-item" href="/categorias"><i class="fas fa-truck-pickup"></i> Veículos <span>1228</span></a></li>
                            <li><a class="dropdown-item" href="/categorias"><i class="fas fa-home"></i> Casa <span>178</span></a></li>
                            <li><a class="dropdown-item" href="/categorias"><i class="fas fa-user-md"></i> Saúde &amp; Beleza <span>7163</span></a></li>
                            <li><a class="dropdown-item" href="/categorias"><i class="fas fa-paw"></i> Pets &amp; Animais <span>8709</span></a></li>
                            </ul>
                        </li>
    ...
    <footer class="main-footer">
        <div class="footer-content">
            <div class="container">
                ...
                <div class="col-xl-12">
                <div class=" text-center paymanet-method-logo"> <img src="images/master_card.png" alt="img"> <img alt="img" src="images/visa_card.png"> <img alt="img" src="images/paypal.png"> <img alt="img" src="images/american_express_card.png"> <img alt="img" src="images/discover_network_card.png"> </div>
