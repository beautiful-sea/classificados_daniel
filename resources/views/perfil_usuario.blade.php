      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="tab-vertical tab-vertical-md py-5 mr-lg-7">
          <div class="pr-md-7 mb-5">
            ...
            <h3 class="author_imgtitle">Jorge Jesus</h3>
          </div>
            ...
            <div class="row">
              <div class="inner-box inner-boxdrash">
                <div class="welcome-msg">
                  <h3 class="page-sub-header2 clearfix no-padding">Olá Jorge Jesus </h3>
                  <span class="page-sub-header-sub small">Entrou pela ultima vez em: 01-01-2019 12:40 AM [UK time (GMT + 6:00hrs)]</span> </div>
