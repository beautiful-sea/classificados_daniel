                    ...
                    <div class="portfolio-wrap grid items-3 items-padding">
                        ...
                        <div class="portfolio-card isotope-item digital photo Classidied-box">
                            <div class="card card-event info-overlay">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title"><a href="addetail.html">Especialista em Instalações e Reparos
                                            Elétricos</a></h4>
                                    <div class="card-event-info">
                                        <p class="event-location"><i class="far fa-compass"></i> <a class="location"
                                                                                                    href="">Valença, Rio
                                                de Janeiro, Centro </a></p>
                        ...
                        <div class="portfolio-card isotope-item marketing marketing Classidied-box">
                            <div class="card card-event info-overlay">
                                <div class="img has-background"
                                     style="background-image: url(images/5.jpg); background-size:cover ">
                                    <a href="addetail.html" class="event-pop-link"> <span class="event-badges "> <span
                                                    class="badge badge-danger"> EM ALTA</span> </span>
                                        <div class="event-pop-info">
                                            ...
                                            <div class="event-rating">
                                                ...
                                                <div class="review-count"> 4.89 | 89 avaliações</div>
                                                                       ...
                                                                       src="images/10x6.gif"> </a></div>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="addetail.html">Pedreiro Especializado em Obras
                                            Residenciais e Comerciais</a></h4>
                                    <div class="card-event-info">
                                        <p class="event-location"><i class="far fa-compass"></i> <a class="location"
                                                                                                    href="">Barra do
                                                Piraí, Rio de Janeiro, Centro </a></p>
                                        <p class="event-time"><i class="far fa-clock"></i> 05/10/2022 09:26 </p>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="pull-left left">
                                        <div class="">por <a href="dashboard-myads.html">Ricardo Oliveira</a><i
                                        ...
                                        <div class="event-pop-info">
                                            ...
                                            <div class="event-rating">
                                                ...
                                                <div class="review-count"> 4.89 | 89 avaliações</div>
                                                                       ...
                                                                       src="images/10x6.gif"> </a></div>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="addetail.html">Soluções Automotivas de Qualidade</a>
                                    </h4>
                                    <div class="card-event-info">
                                        <p class="event-location"><i class="far fa-compass"></i> <a class="location"
                                                                                                    href="">Valença, Rio
