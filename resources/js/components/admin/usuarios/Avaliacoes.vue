                        ...
                        <tr v-if="avaliacoes.length" v-for="avaliacao in avaliacoes" role="row" class="odd">
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a @click="avaliacaoModal = avaliacao" type="button" class="btn btn-primary btn-table"  data-bs-toggle="modal" data-bs-target="#showReviewModal" >
                                        Ver
                                    </a>
...
export default {
    ...
    methods: {
        getAvaliacoes() {
            axios.get('/api/admin/anunciantes/'+this.anunciante_id+'/avaliacoes' )
                .then(response => {
        ...
        deletarAvaliacao(avaliacao) {
            ...
            swal.fire( {
                ...
                if ( result.isConfirmed ) {
                    axios.delete('/api/admin/anunciantes/'+self.anunciante_id+'/avaliacoes/'+avaliacao.id )
                        .then(response => {
                            //toastr de sucesso
                            swal.fire( {
                                title: 'Excluído!',
