<template>
    <div id="form">
        ...
        <div class="col-lg-12 form-group">
            ...
            <input class="form-control" v-model="anunciante.phone" name="telefone" placeholder="Telefone / contato"
                   type="text">
        </div>
        <div class="col-lg-12 form-group">
            <label>Categoria</label>
            <select class="form-control select2" @change="getCategorias"
        ...
        <div class="col-lg-12 form-group">
            <label>CEP</label>
            <input class="form-control" name="codigo-postal" v-model="anunciante.endereco.cep"
                   placeholder="Código Postal" type="text">
        </div>
        <div class="col-lg-12 form-group">
            <label>Endereço</label>
            <input class="form-control" name="endereco" v-model="anunciante.endereco.logradouro" placeholder="Endereço"
                   type="text">
        </div>
        <div class="col-lg-12 form-group">
            <label>Estado</label>
        ...
        <div class="col-lg-12 form-group">
            <label>Cidade</label>
            <select :disabled="!this.anunciante.endereco.estado_id" class="form-control select2"
        ...
        <div class="col-lg-12 form-group">
            <label>Titulo</label>
            <input class="form-control" v-model="anunciante.anunciante.titulo" name="titulo" placeholder="Titulo"
                   type="text">
        </div>
        <!--            Descrição-->
        <div class="col-lg-12 form-group">
            <label>Descrição</label>
            <textarea class="form-control" v-model="anunciante.anunciante.descricao" name="descricao"
                      placeholder="Descrição" type="text"></textarea>
        </div>
        ...
        <div class="col-lg-12 form-group">
            <input value="Atualizar Perfil" @click="atualizarPerfil()" class="btn btn-success regi-btn btn-md"
                   name="atualizar" type="submit">
        </div>
        ...
        <div class="col-lg-12 form-group">
            <input value="Salvar" class="btn btn-success regi-btn btn-md" @click="salvarFotos" name="salvar_fotos"
                   type="submit">
        </div>
