<template>
    <div class="col-12">
        ...
        <div v-if="dataSelecionada && !agendamentoFinalizado">
            ...
            <h3>
                Selecione o horário disponível para o dia
            ...
            <select class="form-control" v-model="horaSelecionada">
                <option v-for="horario in horariosDisponiveis" :value="horario">
                    {{ horario }}
                </option>
            </select>
            ...
            this.attributes.forEach((attribute) => {
                if (attribute.dates.getDate() === data.getDate()) {
                    this.horariosDisponiveis.push(
                        attribute.dates.getHours().toString().padStart(2, "0") +
                            ":" +
                            attribute.dates
                                .getMinutes()
                                .toString()
                    ...
                    console.log(
                        attribute.dates.getHours() +
                            ":" +
                            attribute.dates.getMinutes()
                    );
                }
            });
